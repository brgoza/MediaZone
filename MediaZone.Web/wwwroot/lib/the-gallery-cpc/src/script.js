...
function getNewImages(folderId) {
    //let folderId = document.getElementById('active-folder-id').value;
    $.getJSON('api/ImagesApi/GetGalleryImages?folderId=' + folderId, 
        function (data) {
...
function initGallery() {
    ...
    updateGallery(galleryItems); // once on load
